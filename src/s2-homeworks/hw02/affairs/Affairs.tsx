...
function Affairs({data, deleteAffairCallback, filter, setFilter}: AffairsPropsType) {
    const [filteredAffairs, setFilteredAffairs] = useState<Array<AffairType>>(data)
    const setAll = () => {
    ...
    const setHigh = () => {
        setFilteredAffairs(filteredAffairs)
        setFilter('high')
        // need to fix
    }
    const setMiddle = () => {
